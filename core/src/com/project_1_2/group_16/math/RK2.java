...
public class RK2 implements NumericalSolver{
    ...
    public void solve(float h, StateVector sv) {
        ...
        vel_x1 = ((h/2f) * (k1.dvx_dt + k2.dvx_dt)) + sv.velocity_x;
        vel_y1 = ((h/2f) * (k1.dvy_dt + k2.dvy_dt)) + sv.velocity_y;

        pos_x1 = ((h/2f) * (k1.dx_dt + k2.dx_dt)) + sv.pos_x;
        pos_y1 = ((h/2f) * (k1.dy_dt + k2.dy_dt)) + sv.pos_y;
