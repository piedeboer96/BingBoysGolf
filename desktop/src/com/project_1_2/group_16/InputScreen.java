...
public class InputScreen extends JFrame {
   ...
   /* JLabel sandPitXL = new JLabel("sandPitX : ");
    ...
    public void setUpGUI(){
        ...
        buttonP.setFocusable(false);
        buttonP.addActionListener(e -> runTheGame()); // This is a shortcut for using ActionListener , for more info https://www.youtube.com/watch?v=Kmgo00avvEw
   ...
   /*     sandPitXL.setFont(large);
    ...
    public void runTheGame()
    {
        ...
        x0 = Float.parseFloat(x0T.getText()) ;
        y0 = Float.parseFloat(y0T.getText());
        xt = Float.parseFloat(xtT.getText());
        yt = Float.parseFloat(ytT.getText());
       /* vx = Float.parseFloat(vxT.getText());
        vy = Float.parseFloat(vyT.getText());*/
        ...
        /*sandPitXMin = Float.parseFloat(sandPitXMinT.getText());
        sandPitXMax = Float.parseFloat(sandPitXMaxT.getText());
        sandPitYMin = Float.parseFloat(sandPitYMinT.getText());
        sandPitYMax = Float.parseFloat(sandPitYMaxT.getText());*/
        treesNum = Integer.parseInt(treesNumT.getText());
        sandPitsNum = Integer.parseInt(sandPitsNumT.getText());
